...
class SpaHotel(Hotel):
    ...
    def spa_hotel_package(self):
        print("Spa package added to your booking!")
...
class SpaReservationTicket:
    ...
    def __init__(self, hotel_detail, customer_name):
    ...
    def generate(self):
        ...
        content = f"""
        Thank You for your Spa reservation package!

        Name: {self.customer_name}
        Hotel Name: {self.hotel_detail}
        """
...
if hotel.available():
    ...
    if credit_card.validate(expiration="12/26", holder="JOHN SMITH", cvc="123"):
        ...
        if credit_card.authenticate(given_pass="abc1234"):
            ...
            reservation_ticket = ReservationTicket(hotel, name)

            print(reservation_ticket.generate())

            spa = input("Do you want to add SPA package? (yes/no): ")

            if spa.lower() == "yes":

                hotel.spa_hotel_package()

                spa_ticket = SpaReservationTicket(hotel.name, name)
